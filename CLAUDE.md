...
| 6 | **shnurok** (рекламный рилс кроссовок) | Хук (говорящая голова + титры-лесенка + влёт графики + текст за головой) → тело (b-roll под готовую озвучку + пословные сабы) → CTA. Стили classic/bold. | «собери shnurok», «рекламный рилс кроссовок», «в стиле NUMERIS» | `python -m src.cli shnurok <folder> --style both` |
