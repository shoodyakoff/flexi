...
def compose_hook(th_clip, th_start, dur, front_ass, behind_ass, matte_mp4, car_png,
    ...
    pre = source_tonemap_prefix(th_clip)
    ...
    if behind_ass is not None:
        ...
        fc = (
            f"[0:v]{pre}scale=1080:1920:flags=lanczos,setsar=1,fps=30,format=yuv420p,split=2[b1][b2];"
        ...
        fc = (
            f"[0:v]{pre}scale=1080:1920:flags=lanczos,setsar=1,fps=30,format=yuv420p[base];"
