...
| **QA (meme)** | `qa_meme.py` | Проверяет формат готовых вариантов (1080×1920, 30fps, есть звук). Стык лицо→панч и читаемость подписей — визуально по кадрам при рендере; дедуп-дистанция (vpdq) — будущее дополнение. |
